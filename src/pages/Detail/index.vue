        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="saleAttr in spuSale" :key="saleAttr.id">
                <dt class="title">{{ saleAttr.saleAttrName }}</dt>
                <dd
                  changepirce="0"
                  :class="{ active: ValueList.isChecked == '1' }"
                  v-for="ValueList in saleAttr.spuSaleAttrValueList"
                  :key="ValueList.id"
                  @click="
                    changeActive(ValueList, saleAttr.spuSaleAttrValueList)
                  "
                >
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <a href="javascript:" @click="sendShopping()">加入购物车</a>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  computed: {
    ...
    ...mapGetters(["categoryView", "skuInfo", "spuSale"]),
    skuImageList() {
      return this.skuInfo.skuImageList || [];
    },
  },
  methods: {
    changeActive(attr2, attr) {
      attr.forEach((el) => {
        el.isChecked = "0";
      });
      attr2.isChecked = "1";
